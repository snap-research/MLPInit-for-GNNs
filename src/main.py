...
def arg_parse():
    ...
    parser.add_argument("--dataset", type=str,
                        default="Products", required=False,)
    parser.add_argument('--type_model', type=str, default="GraphSAGE",
                        choices=['GraphSAGE', 'ClusterGCN', 'GraphSAINT', "GAT", "GCN"])
    parser.add_argument('--exp_name', type=str, default='')
    parser.add_argument('--N_exp', type=int, default=20)
    parser.add_argument('--resume', action='store_true', default=False)
    parser.add_argument("--cuda", type=bool, default=True,
                        required=False, help="run in cuda mode")
    ...
    parser.add_argument("--multi_label", type=bool,
                        default=False, help="multi_label or single_label task")
    ...
    parser.add_argument('--walk_length', type=int, default=2,
                        help='walk length of RW sampler')
    ...
    # added
    parser.add_argument('--train_gnn_type', type=str,
                        default='gnn', choices=['gnn', 'mlp'])
    ...
    parser.add_argument('--pretrained_checkpoint', type=str,
                        default="no_pretrained_checkpoint")
